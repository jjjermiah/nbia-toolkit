...
class Login(BaseModel):
    ...
    nbia_username: str = Field(default="nbia_guest", description="NBIA Username")
    nbia_password: str = Field(default="", description="NBIA Password")
...
if __name__ == "__main__":
    ...
    # write schema
    Settings().write_json_schema(Path("settings.schema.json"))
